...
Camera::Camera(std::shared_ptr<Device> device): m_device(device), m_shouldClear(true), m_numberOfImages(0) {}

Camera::~Camera() {}

bool Camera::create(size_t numberOfImages, int width, int height) {
